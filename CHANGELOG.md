...
### Fixed
- Added write permissions to release job
- Changed npm audit level to high (reduce false positives)
...
### Fixed
- Security check now only scans src/ and scripts/ directories
- Added Node.js 16.x and 22.x to test matrix
- Total test combinations: 12 (4 Node versions × 3 OS)
...
### Fixed
- Security check now excludes documentation files from private key scan
...
- Deleted internal development documents
